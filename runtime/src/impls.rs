...
use sp_runtime::{
    traits::{DispatchInfoOf, Convert, PostDispatchInfoOf, Zero, Saturating, SaturatedConversion},
        ...
        T::Call: GetCallMetadata,
{
    ...
    fn withdraw_fee(
        ...
        let special_call = CallMetadata { function_name: "calculate_reward".into(), pallet_name: "Payment".into() };
